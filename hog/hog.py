...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while cnt < num_rolls:
        ...
        score += tmp
        cnt += 1
    return score if flag is False else 1    
    # END PROBLEM 1
...
def is_swap(player_score, opponent_score):
    ...
    if opponent_score == opponent_score % 100:
        tens = opponent_score // 10
    else:
        tens = (opponent_score - opponent_score // 100 * 100) // 10
    return diff == tens
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            bouns0 = take_turn(strategy0(score0, score1), score1, dice)
            
            if feral_hogs:
                if abs(last0 - strategy0(score0, score1)) == 2:
                    score0 = score0 + bouns0+ 3   
                else:
                    score0 += bouns0
                last0 = bouns0
            else:
        ...
        if who == 1:
            bouns1 = take_turn(strategy1(score1, score0), score0, dice)

            if feral_hogs:
                if abs(last1 - strategy1(score1, score0)) == 2:
                    score1 = score1 + bouns1 + 3
                else:
                    score1 += bouns1
                last1 = bouns1
            else:
